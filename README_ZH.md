...
下载 [CCRemoteServer-v1.1.0.dmg](https://github.com/AndyChang33/cc-remote/releases/latest/download/CCRemoteServer-v1.1.0.dmg) — macOS 菜单栏应用，一键启动/停止服务器，查看用量费用，配置端口和工作目录。沙盒模式限制远程终端只能在安全目录内操作。无需终端。
